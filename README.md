# chenile-parent
This contains the parent pom that everyone can use as their super pom. It standardizes the frameworks
that we will use across chenile and external dependencies.

It also inherits from Spring POM and hence in the process standardizes Spring related dependencies.
